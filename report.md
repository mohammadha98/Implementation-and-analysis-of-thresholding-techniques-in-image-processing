...
<div align="center">
  <img src="sample_image.jpg" alt="تصویر ورودی با نورپردازی غیریکنواخت" width="600">
  <br>
  <em>شکل ۱: تصویر ورودی با گرادیان نوری از چپ (تاریک) به راست (روشن)</em>
</div>
...
<div align="center">
  <img src="Figure_1.png" alt="نتایج مقایسه‌ای تکنیک‌های آستانه‌گذاری" width="800">
  <br>
  <em>شکل ۲: نتایج مقایسه‌ای تکنیک‌های مختلف آستانه‌گذاری</em>
</div>
